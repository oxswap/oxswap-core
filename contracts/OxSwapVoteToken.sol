...
// OxSwap Vote Token Can not be Transfered by users. only the owner //masterchef
...
contract OxSwapVoteToken is ERC20SNT("OxSwap Vote Token", "OXSVT", address(0)), Ownable {
